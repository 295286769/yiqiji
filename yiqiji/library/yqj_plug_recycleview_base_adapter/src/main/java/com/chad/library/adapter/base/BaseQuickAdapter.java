...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    protected K createBaseViewHolder(ViewGroup parent, int layoutResId,Class kClass) {
        return createBaseViewHolder(getItemView(layoutResId, parent),kClass);
    }
    /**
    ...
    protected K createBaseViewHolder(View view) {
        Log.v(BaseQuickAdapter.class.getName(),"createBaseViewHolder()");
        Class temp = getClass();
        Class z = null;
     ...
     */
    @SuppressWarnings("unchecked")
    protected K createBaseViewHolder(View view,Class kClass) {
        Log.v(BaseQuickAdapter.class.getName(),"createBaseViewHolder()");
        K k = createGenericKInstance(kClass, view);
        return null != k ? k : (K) new BaseViewHolder(view);
    }
